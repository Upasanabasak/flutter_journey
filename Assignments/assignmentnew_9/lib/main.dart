...
class BiodataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Biodata Profile'), elevation: 0),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 4),
                        Text('6A, Iswar Mitra Lane, kolkata - 700006'),
                        Text('Email: basakupasana2005@gmail.com'),
                        Text('Contact: +91 7439627875'),
                      ],
                    ),
                  ),
                ],
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _infoRow('Date of Birth', '01 November 2005'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '• Participated in inter-school debate competitions',
                    ),
                  ],
                ),
              ),
